...
<head>
    ...
    <title>Women's Leather Products | Leather Shop</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    $sql = "SELECT * FROM admin_product WHERE product_category = 'women' LIMIT 4"; // limit to 6 items
    $result = $conn->query($sql);
    ?>
    <!-- Women’s Leather Products Section -->
    <section class="women-section">
        <h1>Women’s Leather Collection</h1>
        <!-- Filter Section -->
        ...
        <div class="product-grid" id="productGrid">
            <?php while ($row = $result->fetch_assoc()): ?>
                <!-- <div class="product-item" data-price="1500"> -->
